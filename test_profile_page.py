...
class ProfilePageTest(unittest.TestCase, FunctionalTestCase):
  ...
  def test_ProfilePage(self):
    if functest.isElementDisplayed(5, "Username") is True:
      functest.wait(3) 
    ...
    functest.wait(2)     
    functest.clearField("id", "Im_handle")
    functest.wait(2)     
    functest.writeTextField("id", "New_im_handle")
    functest.wait(2)
    functest.Browser.execute_script("window.scrollTo(0, document.body.scrollHeight);")     
    functest.clearField("id", "Im_network")
    functest.wait(2)     
    functest.writeTextField("id", "New_im_network")
    functest.wait(2)     
    functest.clearField("id", "Home_page_url")
    functest.wait(3)     
    functest.writeTextField("id", "New_homepage_url")
    functest.wait(3)     
    functest.clearField("id", "Blog_url")
    functest.wait(3) 
    functest.writeTextField("id", "New_blog_url")
    functest.wait(3)
    functest.Browser.execute_script("window.scrollTo(0, document.body.scrollHeight);")    
    functest.wait(3) 
    functest.setDropDownList("New_t_shirt_size")
    functest.wait(3) 
    functest.clearField("xpath", "Phone")
    functest.wait(3) 
    functest.writeTextField("xpath", "New_phone_number")  
